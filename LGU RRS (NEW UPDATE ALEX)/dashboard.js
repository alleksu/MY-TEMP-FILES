...
const ALL_CARDS = [
  { id: 'hl-card-1', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2.5"/><path d="M12 6v1.5M12 16.5V18M9 9.5c0-1.1.9-2 2-2h2a2 2 0 0 1 0 4h-2a2 2 0 0 0 0 4h2a2 2 0 0 0 2-2" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/></svg>`, name: 'Collected Today' },
  { id: 'hl-card-2', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M6 2h12a1 1 0 0 1 1 1v18l-3-2-2 2-2-2-2 2-2-2-3 2V3a1 1 0 0 1 1-1Z" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round"/><path d="M9 8h6M9 12h6M9 16h3" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/></svg>`, name: 'Payments Recorded' },
  { id: 'hl-card-3', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M9 11l2 2 4-4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 4h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Z" stroke="currentColor" stroke-width="2.5"/></svg>`, name: 'Requests for Approval' },
  { id: 'hl-card-4', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2.5"/><path d="M3 9h18M8 2v4M16 2v4" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><rect x="7" y="13" width="3" height="3" rx="0.5" fill="currentColor"/></svg>`, name: 'Month-to-Date Collection' },
  { id: 'hl-card-5', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2.5"/><circle cx="12" cy="12" r="5" stroke="currentColor" stroke-width="2.5"/><circle cx="12" cy="12" r="2" fill="currentColor"/></svg>`, name: 'Daily Target' },
  { id: 'hl-card-6', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2.5"/><path d="M12 7v5l3 3" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`, name: 'Shift Tracker' },
  { id: 'hl-card-7', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M18 20V10M12 20V4M6 20v-6" stroke="currentColor" stroke-width="3" stroke-linecap="round"/></svg>`, name: 'Top Revenue Today' },
  { id: 'hl-card-8', icon: `<svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2.5"/><path d="M12 7v5" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><circle cx="12" cy="16" r="1.5" fill="currentColor"/></svg>`, name: 'Oldest Pending' },
];
